...
## This is an adaption of CLT installer script that GitHub use: https://github.com/actions/virtual-environments/blob/main/images/macos/provision/core/xcode-clt.sh
