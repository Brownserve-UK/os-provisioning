...
/Volumes/Image\ Volume/Install*.app/Contents/Resources/startosinstall --agreetolicense --rebootdelay 90 --installpackage packer_user.pkg --installpackage configure_ssh.pkg --installpackage oobe.pkg --volume /Volumes/11vm
